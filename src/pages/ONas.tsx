...
const teamData = {
  pl: [
    ...
    { name: 'Kebba', role: 'Opiekun domu polskiego w Gambii', image: teamKebba },
  ...
  en: [
    ...
    { name: 'Kebba', role: 'Caretaker of the Polish House in Gambia', image: teamKebba },
  ...
  nl: [
    ...
    { name: 'Kebba', role: 'Beheerder van het Poolse Huis in Gambia', image: teamKebba },
